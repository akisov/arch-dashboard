          ...
          <table className="w-full">
            <thead>
              <tr className="bg-secondary/50">
                ...
                <th className="text-center pl-4 pr-10 py-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground whitespace-nowrap cursor-pointer select-none"
            ...
            <tbody className="divide-y divide-border">
              {sorted.map(t => (
                <tr key={t.key} className="hover:bg-secondary/30 transition-colors group">
                  ...
                  <td className="pl-4 pr-10 py-4 text-center">
                    {t.total > 0
